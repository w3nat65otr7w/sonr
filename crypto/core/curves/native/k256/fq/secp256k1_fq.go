...
func FromMontgomery(out1 *NonMontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement) {
	...
	var x61 uint64
	x60, x61 = bits.Add64(
		(uint64(uint1(x35)) + uint64(uint1(x27))),
		(uint64(uint1(x51)) + x39),
		uint64(uint1(x59)),
	)
	var x62 uint64
	var x63 uint64
	...
	var x95 uint64
	x94, x95 = bits.Add64(
		(uint64(uint1(x69)) + uint64(uint1(x61))),
		(uint64(uint1(x85)) + x73),
		uint64(uint1(x93)),
	)
	var x96 uint64
	var x97 uint64
	...
	var x128 uint64
	var x129 uint64
	x128, x129 = bits.Add64(
		(uint64(uint1(x103)) + uint64(uint1(x95))),
		(uint64(uint1(x119)) + x107),
		uint64(uint1(x127)),
	)
	var x130 uint64
	var x131 uint64
...
func ToMontgomery(out1 *MontgomeryDomainFieldElement, arg1 *NonMontgomeryDomainFieldElement) {
	...
	var x92 uint64
	x91, x92 = bits.Add64(
		((uint64(uint1(x66)) + uint64(uint1(x44))) + (uint64(uint1(x58)) + x46)),
		(uint64(uint1(x82)) + x70),
		uint64(uint1(x90)),
	)
	var x93 uint64
	var x94 uint64
	...
	var x139 uint64
	var x140 uint64
	x139, x140 = bits.Add64(
		((uint64(uint1(x114)) + uint64(uint1(x92))) + (uint64(uint1(x106)) + x94)),
		(uint64(uint1(x130)) + x118),
		uint64(uint1(x138)),
	)
	var x141 uint64
	var x142 uint64
	...
	var x187 uint64
	var x188 uint64
	x187, x188 = bits.Add64(
		((uint64(uint1(x162)) + uint64(uint1(x140))) + (uint64(uint1(x154)) + x142)),
		(uint64(uint1(x178)) + x166),
		uint64(uint1(x186)),
	)
	var x189 uint64
	var x190 uint64
