...
func fiat_pasta_fq_addcarryx_u64(
	x uint64,
	y uint64,
	carry fiat_pasta_fq_uint1,
) (uint64, fiat_pasta_fq_uint1) {
...
func fiat_pasta_fq_subborrowx_u64(
	x uint64,
	y uint64,
	carry fiat_pasta_fq_uint1,
) (uint64, fiat_pasta_fq_uint1) {
...
//	0 ≤ eval out1 < m
func fiat_pasta_fq_mul(
	out1 *fiat_pasta_fq_montgomery_domain_field_element,
	arg1 *fiat_pasta_fq_montgomery_domain_field_element,
	arg2 *fiat_pasta_fq_montgomery_domain_field_element,
) {
	x1 := arg1[1]
	x2 := arg1[2]
	x3 := arg1[3]
...
//	0 ≤ eval out1 < m
func fiat_pasta_fq_from_montgomery(
	out1 *fiat_pasta_fq_non_montgomery_domain_field_element,
	arg1 *fiat_pasta_fq_montgomery_domain_field_element,
) {
	x1 := arg1[0]
	var x2 uint64
	...
	x30, x31 = fiat_pasta_fq_addcarryx_u64(
		(uint64(x17) + (uint64(x15) + (uint64(x11) + x7))),
		x26,
		x29,
	)
	var x32 uint64
...
//	0 ≤ eval out1 < m
func fiat_pasta_fq_to_montgomery(
	out1 *fiat_pasta_fq_montgomery_domain_field_element,
	arg1 *fiat_pasta_fq_non_montgomery_domain_field_element,
) {
	x1 := arg1[1]
	x2 := arg1[2]
	x3 := arg1[3]
	...
	x97, x98 = fiat_pasta_fq_addcarryx_u64(
		((uint64(x76) + (uint64(x58) + (uint64(x50) + x38))) + x62),
		x89,
		x96,
	)
	var x99 uint64
	...
	x137, x138 = fiat_pasta_fq_addcarryx_u64(
		((uint64(x116) + (uint64(x98) + (uint64(x90) + x78))) + x102),
		x129,
		x136,
	)
	var x139 uint64
...
func fiat_pasta_fq_selectznz(
	out1 *[4]uint64,
	arg1 fiat_pasta_fq_uint1,
	arg2 *[4]uint64,
	arg3 *[4]uint64,
) {
	var x1 uint64
