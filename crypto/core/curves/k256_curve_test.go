...
func TestScalarK256Random(t *testing.T) {
	...
	expected, _ := new(
		big.Int,
	).SetString("2f71aaec5e14d747c72e46cdcaffffe6f542f38b3f0925469ceb24ac1c65885d", 16)
...
func TestScalarK256Hash(t *testing.T) {
	...
	expected, _ := new(
		big.Int,
	).SetString("e5cb3500b809a8202de0834a805068bc21bde09bd6367815e7523a37adf8f52e", 16)
	require.Equal(t, s.value.BigInt(), expected)
}
...
func TestScalarK256Invert(t *testing.T) {
	...
	bn, _ := new(
		big.Int,
	).SetString("8e38e38e38e38e38e38e38e38e38e38d842841d57dd303af6a9150f8e5737996", 16)
...
func TestPointK256Random(t *testing.T) {
	...
	expectedX, _ := new(
		big.Int,
	).SetString("c6e18a1d7cf834462675b31581639a18e14fd0f73f8dfd5fe2993f88f6fbe008", 16)
	expectedY, _ := new(
		big.Int,
	).SetString("b65fab3243c5d07cef005d7fb335ebe8019efd954e95e68c86ef9b3bd7bccd36", 16)
...
func TestPointK256Hash(t *testing.T) {
	...
	expectedX, _ := new(
		big.Int,
	).SetString("95d0ad42f68ddb5a808469dd75fa866890dcc7d039844e0e2d58a6d25bd9a66b", 16)
	expectedY, _ := new(
		big.Int,
	).SetString("f37c564d05168dab4413caacdb8e3426143fc5fb24a470ccd8a51856c11d163c", 16)
	require.Equal(t, s.X().BigInt(), expectedX)
	require.Equal(t, s.Y().BigInt(), expectedY)
}
