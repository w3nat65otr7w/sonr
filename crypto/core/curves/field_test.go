...
func TestElementMarshalJsonRoundTrip(t *testing.T) {
	reallyBigInt1, ok := new(
		big.Int,
	).SetString("12365234878725472538962348629568356835892346729834725643857832", 10)
	require.True(t, ok)

	reallyBigInt2, ok := new(
		big.Int,
	).SetString("123652348787DEF9DEA2F79CD65812631A5CF5D3ED46729834725643857832", 16)
	require.True(t, ok)
