...
func (prover *InnerProductProver) rangeToIPP(
	proofG, proofH []curves.Point,
	l, r []curves.Scalar,
	tHat curves.Scalar,
	capPhmuinv, u curves.Point,
	transcript *merlin.Transcript,
...
func (prover *InnerProductProver) proveRecursive(
	recursionParams *ippRecursion,
) (*InnerProductProof, error) {
	// length checks
...
func (prover *InnerProductProver) calcx(
	capL, capR curves.Point,
	transcript *merlin.Transcript,
) (curves.Scalar, error) {
