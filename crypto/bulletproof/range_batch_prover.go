...
// blinding factors.
func (prover *RangeProver) BatchProve(
	v, gamma []curves.Scalar,
	n int,
	...
	ipp, err := prover.ippProver.rangeToIPP(
		proofG,
		hPrime,
		l,
		r,
...
func getPhmuBatched(
	proofG, proofHPrime []curves.Point,
	h, capA, capS curves.Point,
	x, y, z, mu curves.Scalar,
	n, m int,
	curve curves.Curve,
) curves.Point {
	twoN := get2nVector(n, curve)
